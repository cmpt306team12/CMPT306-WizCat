    ...
    private void Start()
    {
        ...
        if (PerkNames)
        {
            ...
            switch (perkID)
            {
                ...
                case 2: // Slower Proj
                    perktext.text = "Speed Down, Damage Up";
                    price = tier1;
                    break;

                case 3: // Projectile duration up
                    perktext.text = "Projectile Duration Up";
                    price = tier1;
                    break;

                case 4: // Projectile duration down
                    perktext.text = "Duration Down, Size Up";
                    price = tier1;
                    break;

                case 5: // Damage up
                    perktext.text = "Damage Up";
                    price = tier2;
                    break;
                ...
                case 8: // Size up
                    ...
                    break;
                case 9: // Size down
                    perktext.text = "Size Down, Speed Up";
                    price = tier1;
                    break;
                case 10: // Burst shot
